		...
		<div class="row profile">
			<div class="col-md-3">
				<div class="profile-sidebar">
					...
					<div class="profile-userpic">
						<img src="nitish.jpg" class="img-responsive" alt="">
					</div>
					<!-- END SIDEBAR USERPIC -->
					<!-- SIDEBAR USER TITLE -->
					<div class="profile-usertitle">
						<div class="profile-usertitle-name">Nitish Srivastava</div>
			...
			<div class="col-md-9">
				<div class="row">
					<div class="col-sm-3">
						<div class="well">
							<p>name of moderator who started it</p>
							<img src="" class="img-circle" height="55" width="55"
								alt="started by ki photo">
						</div>
					</div>
					<div class="col-sm-9">
						<div class="well">
