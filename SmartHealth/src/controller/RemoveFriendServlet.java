...
public class RemoveFriendServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Remove Friend servlet");
		...
		String removename = request.getParameter("removename").toString();
		
		String result="";
		try {
			result = FriendshipDBHandler.removeFriend(user.getUsername(),removename);
