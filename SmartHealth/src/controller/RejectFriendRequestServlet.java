...
public class RejectFriendRequestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Reject Friend servlet");
		...
		String acceptname = request.getParameter("rejectname").toString();
		
		String result="";
		try {
			result = FriendshipDBHandler.rejectFriendRequest(acceptname, user.getUsername());
